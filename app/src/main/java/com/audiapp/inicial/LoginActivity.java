...
//      Nick;
@Nullable
@BindView(R.id.inputlayout_login_nick)      TextInputLayout ref_til_nick;
@Nullable
@BindView(R.id.edit_login_nick)             EditText ref_edit_nick;
//      Contraseña;
@Nullable
@BindView(R.id.inputlayout_login_password)  TextInputLayout ref_til_passw;
@Nullable
@BindView(R.id.edit_login_password)         EditText ref_edit_passw;
